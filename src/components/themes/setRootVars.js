...
export const setRootVariables = (colorSet) => {
  ...
  root.style.setProperty('--featherGrey', colorSet.featherGrey)
  root.style.setProperty('--black', colorSet.black)
  root.style.setProperty('--white', colorSet.white)
  root.style.setProperty('--inactive', colorSet.inactive)
